...
## 22-09-26
- Infinite SB mod acquisition, seems to handle higher data rate than T mode; but eventually crashes too.
- Exploiting higher incident count rate (3-4 Mcps per pixel) to sweep different pixel pairs- SNR ~10 in roughly 30 minutes!
- Some failed attempts for automatic sweeping of pixel pairs.
- Successful bunching measurements on master pixel pairs!
