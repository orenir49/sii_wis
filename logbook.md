...
- Real time acquisition with mask_seven.txt
  ...
  - **Only remaining task on the T-mode plan: tag `main` for the SB-mode legacy state, then merge T-mode and all other changes (including docs) from `wire-encoding-bakeoff` into `main`.**
